        ...
        if (config.path) {
            ...
            if (expressApp.use &&
                ...
                try {
                    ...
                    console.log('Could not load @feathersjs/express for static serving, falling back to HTML serving');
                }
            }
            ...
            if (expressApp.get && typeof expressApp.get === 'function') {
                ...
                expressApp.get(config.path, (req, res) => {
                ...
                console.log(`🎮 Feathers Playground (Feathers service fallback) available at ${config.path}`);
            }
        }
